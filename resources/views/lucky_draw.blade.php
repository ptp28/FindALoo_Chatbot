...
<html>
	<head>
		<title>Findaloo - Lucky Draw!!</title>
		<meta charset="utf-8" />
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Intro -->
					<section class="intro">
						<header>
                            {{-- <a href="#" class="image"><img src="img/EyantraLogoLarge.png" data-position="top left" alt="" width="70%"/></a> --}}
                            
                            <h1><img src="img/EyantraLogoLarge.png" data-position="top left" alt="" width="70%"/></h1>
                            <h2>FindaLoo</h2>
                            <h3>Lucky Draw</h3>
                            <p>Click below for lucky draw</p>
                        <form method="POST" action="{{route('luckyDrawResult')}}">
                            <button type="submit" class="arrow scrolly">Draw</button>
                        </form>
							<ul class="actions">
						...
						<div class="content">
                            <h1 style="align-content: center">Winner:</h1>
                            @if(isset($data))
					...
					<section id="first">
						<header>
                            <h2>Todays Lucky Winners:</h2>
                        <h2>Number of Winners: {{$count}}</h2>
						</header>
						<div class="content">
							<p>Below are the <strong>Emails</strong> .</p>
							<ul class="feature-icons">
                                @if(isset($lucky_user))
                                    @foreach($lucky_draw_user as $cur)
                                    <li class="icon solid fa-bolt">{{$cur}}</li>
                                    @endforeach
                                @endif
							</ul>
					...
					<section>
						...
						<footer>
							<ul class="items">
								...
								<li>
									<h3>Address</h3>
									<span>SIC 102, ERTS Lab, KRESit Building, IIT Bombay</span>
								</li>
								<li>
									<h3>Elsewhere</h3>
									<ul class="icons">
										<li><a href="https://twitter.com/eyantra_iitb?lang=en" class="icon brands fa-twitter"><span class="label">Twitter</span></a></li>
										<li><a href="https://www.facebook.com/eyantra/" class="icon brands fa-facebook-f"><span class="label">Facebook</span></a></li>
										<li><a href="https://www.instagram.com/eyantra/?hl=en" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li>
										<li><a href="https://www.linkedin.com/company/e-yantraiitb/" class="icon brands fa-linkedin-in"><span class="label">LinkedIn</span></a></li>
										<li><a href="https://github.com/eyantra?tab=repositories" class="icon brands fa-github"><span class="label">GitHub</span></a></li>
